<?php
	...
	if(isset($_POST['update']))
    {
        ...
        {
            $sql = "UPDATE `users` SET `Name`='$name',`F_name`='$fname',`Address`='$address',`cnic_no`='$cnic_no',`contact_no`='$contact_no',`email`='$email',`password`='$password',`user_status`='$user_status' WHERE `id`='$id'";
								...
								<form method="POST">
									...
									<div class="row">
										...
										<div class="form-group col-sm-6">
											...
											<input type="text" name="cnicno" onkeyup="stopcursor(this)" value="<?php echo $result['cnic_no'];?>" placeholder="Enter House Number..." class="form-control" required />
											<?php echo $msg13; ?>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="form-group col-sm-6">
											...
											<select type="text" name="user_status" value="<?php echo $result['user_status'];?>" class="custom-select">
											<?php
