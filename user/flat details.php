<?php
	...
	if(isset($_POST['send']))
    {
		...
		{
			$sql = "INSERT INTO `comments`(`Name`, `email`, `contact_no`, `comments`, `date`, `p_id`, `owner_id`) VALUES ('$name','$email','$contact_no','$message','$date','$p_id','$owner')";
            ...
            if($data = true)
            {
				...
				if($msg)
				{
					header("Refresh: 0; url=flat details.php?f_id=".$id);
				}					
            }
            else
            {
										  ...
										  <div class="col-md-12 col-lg-4">
											<div class="property-contact">
											  <form class="form-a" method="POST">
												<?php echo $msg;?>
												<div class="row">
												<input type="hidden" name="owner" value="<?php echo $User_info['id'];?>">
