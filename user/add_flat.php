<?php
	...
	if(isset($_POST['add']))
    {
        ...
        {
            $sql = "INSERT INTO `flats`(`area`, `price`, `status`, `agent_name`, `pic`, `pic2`, `location`, `discription`, `Date`, `rooms`, `bathrooms`, `garage`, `kitchan`, `u_id`) VALUES ('$area','$price','$status','$agent_name','$pic','$pic2','$location','$discription','$date','$rooms','$bathrooms','$garage','$kitchan','$u_id')";
								...
								<form method="POST" enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="form-group col-sm-6">
											...
											<select name="fullname"  id="agent"  class="custom-select" >
												<option value='' selected ='selected'  hidden> Select Agent</option>
												<?php $ret=mysqli_query($con, "select * from agents_details");
													while($row=mysqli_fetch_array($ret))
													{
														...
														$name = $row['fullname'];
															...
															?>
													<option value="<?php echo $id; ?>"><?php echo $name; ?><?php ?></option>
