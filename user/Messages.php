                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
											...
											$_SESSION['user_id']=$user_id; 
												...
												$query="SELECT * FROM `comments` WHERE `owner_id`='$user_id' ";
											...
											?>
														<tr>
															...
															<td>
																...
																<a href="reply_message.php?m_id=<?php echo $data['id'];?>" class="btn btn-xs btn-success editbtn"><span class="fa fa-info"></span>  </a>
															</td>
														</tr>
											<?php 
													}
