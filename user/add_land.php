<?php
	...
	if(isset($_POST['add']))
    {
        ...
        {
            $sql = "INSERT INTO `lands`(`area`, `price`, `status`,`agent_name`,`pic`, `pic2`, `location`, `discription`, `Date`, `u_id`) VALUES ('$area','$price','$status','$agent_name','$pic','$pic2','$location','$discription','$date','$u_id')";
