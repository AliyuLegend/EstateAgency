				...
				<!-- Content Header (Page header) -->
					<div class="content-header">
					  <div class="container-fluid">
						<div class="row mb-2">
						  <div class="col-sm-6">
							<h1 class="m-0 text-dark"> All Reply</h1>
						  </div><!-- /.col -->
						  <div class="col-sm-6">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p> All of the Reply which are Send by the user.</p>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
											...
											$_SESSION['user_id']=$user_id; 
												...
												$query="SELECT * FROM `replies` WHERE `p_id`='$user_id' ";
											...
											?>
														<tr>
															...
															<td>
																<a href="delete_reply.php?m_id=<?php echo $data['id'];?>" class="btn btn-xs btn-danger"><span class="fa fa-trash"></span>  </a>
															</td>
														</tr>
											<?php 
													}
