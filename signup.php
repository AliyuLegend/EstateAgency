<?php 
    ...
    if(isset($_POST['submit']))
    {
		...
		elseif (empty($cnic_no)) 
	 	{
	 		$msg12="<div class='error'> Enter Your House/Contact Number </div>";	
	 	}
        ...
        {
            $msg13="<div class='error'>*** This House Number Already Exists. </div>";  
        }
            ...
            <div class="login-box ptb--100">
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="login-form-body">
						...
						<div class="row form-group">
							<div class="col-12">
							<label class="form-control-label"><b>Other Name:</b></label>
						...
						<div class="row form-group">
							<div class="col-12">
							 <label class="form-control-label"><b>House No:</b></label>
								<input type="text" name="cnicno" minlength="1" maxlength="7" onkeyup="stopcursor(this)" value="<?php echo $cnic_no;?>" placeholder="House Number..." class="form-control" required />
								<?php echo $msg13; ?>
							</div>
						</div>
                        <div class="row form-group">
						...
						<div class="row form-group">
							<div class="col-12">
							<label class="form-control-label"><b>Retype-Pass:</b></label>
